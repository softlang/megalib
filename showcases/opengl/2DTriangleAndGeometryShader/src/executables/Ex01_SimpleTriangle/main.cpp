...
/******************************************************************************************************
 * Code in most parts from https://github.com/opengl-tutorials/ogl/tree/master/tutorial02_red_triangle
 *****************************************************************************************************/
...
int main(void)
{
	...
	GLuint programID = loadShaders(SHADERS_PATH "/Examples/ex01_simpleTriangle.vert", SHADERS_PATH "/Examples/ex01_simpleTriangle.frag");
