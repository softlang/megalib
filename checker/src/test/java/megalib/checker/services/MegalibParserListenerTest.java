 ...
 * Especially the constraints relevant for creation time are tested. TODO : Test
 * Substitutes
 *
 * @author heinz
 */
public class MegalibParserListenerTest {
    ...
    public void preludeIsParsed() {
        ...
        assertEquals(0, model.getSubstitutions().size());
    ...
    public void addSubtypeInvalidSupertype() {
        ...
        assertTrue(m.getCriticalWarnings()
    ...
    public void addInstanceOfMulitple() {
        ...
        assertEquals(1, m.getCriticalWarnings().size());
        assertTrue(m.getCriticalWarnings()
                    .contains("Error at t: Multiple types cannot be assigned to the same instance."));
    }
