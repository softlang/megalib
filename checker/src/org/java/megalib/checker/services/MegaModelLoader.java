...
public class MegaModelLoader {
	...
	try {
		...
		if (!model.getCriticalWarnings().isEmpty()) {
		    ...
		    throw new WellFormednessException(
			    "Resolve critical errors first" + (abspath.equals("") ? " in " + abspath : ""));
		}
	    }
	} catch (IOException e) {
	    System.err.println(e.getMessage());
    ...
    public MegalibBaseListener parse(String data, MegalibBaseListener listener)
	    throws MegalibParserException, IOException {
